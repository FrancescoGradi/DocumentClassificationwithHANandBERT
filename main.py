...
if __name__ == '__main__':
    ...
    kdLstmTrain(dataset_name, n_classes, teacher_path='models/model_IMDB_bert/20200605-184848', student_path='models/model_IMDB_kdLstm/ckp_21epochs_20200621-214703', from_checkpoint=True)
